...
class DownloadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post downloads_url, params: { download: { Document_id: @download.Document_id, User_id: @download.User_id } }
    end
  ...
  test "should update download" do
    patch download_url(@download), params: { download: { Document_id: @download.Document_id, User_id: @download.User_id } }
